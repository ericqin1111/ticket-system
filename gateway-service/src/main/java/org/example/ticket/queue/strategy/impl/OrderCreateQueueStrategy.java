...
@Component
public class OrderCreateQueueStrategy implements QueueStrategy {
    ...
    private static final Logger log = LoggerFactory.getLogger(OrderCreateQueueStrategy.class);
    ...
    public boolean support(ServerWebExchange exchange) {
        ...
        return MATCHER.match(ORDER_CREATE_PATH,path);
    }
